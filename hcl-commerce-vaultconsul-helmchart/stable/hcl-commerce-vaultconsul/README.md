...
vaultConsul.vaultImageTag | 1.9.9 | Vault Docker Image tag
...
> **Note**
vault:1.9.9 has been tested.  There is no guarantee that other tags for those docker images will work as expected.
